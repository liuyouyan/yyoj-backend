...
import com.liuyouyan.yyoj.common.constant.CommonConstant;
import com.liuyouyan.yyoj.common.exception.BusinessException;
import com.liuyouyan.yyoj.mapper.PostFavourMapper;
import com.liuyouyan.yyoj.mapper.PostMapper;
import com.liuyouyan.yyoj.mapper.PostThumbMapper;
import com.liuyouyan.yyoj.model.entity.Post;
import com.liuyouyan.yyoj.model.entity.PostFavour;
...
import com.liuyouyan.yyoj.common.utils.SqlUtils;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public void validPost(Post post, boolean add) {
        ...
        // 创建时，参数不能为空
        if (add) {
            ThrowExceptionUtils.throwIf(StringUtils.isAnyBlank(title, content, tags), ErrorCodeEnum.PARAMS_ERROR);
        }
        // 有参数则校验
        if (StringUtils.isNotBlank(title) && title.length() > 80) {
            throw new BusinessException(ErrorCodeEnum.PARAMS_ERROR, "标题过长");
        }
